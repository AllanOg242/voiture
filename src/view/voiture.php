...
<div id="wrapper">
	<h1>Nos Voitures</h1>
	<div class="section noover">
            <div class="container">
            	<div class="row">
            		<div class="col-md-12" style="background-color:none">
                        <div class="tagline-message">
                        	<h2>Nos mercedes SUV(cliquez sur l'image pour plus d'informations)</h2>
                        </div>
                    </div>
            	</div>
                <div class="row">
                    <div class="col-md-6" style="background-color:none">
                        <div class="tagline-message">
                        	<img src="public/images/merco2.jpg" alt="" class="img-responsive">
                        	<h1>Mercedes GlE <br> 14 990€</h1>
                        	<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalQuickView">Voir plus</button>

                        </div>
                    </div>
                    <div class="col-md-6" style="background-color:none">
                        <div class="tagline-message">
                        	<img src="public/images/merco6.jpg" alt="" class="img-responsive">
                        	<h1>Mercedes Class G <br> 17 540€</h1>
                        	<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalQuickView">Voir plus</button>
                        </div>
                    </div><!-- end col -->
                </div><!-- end row -->
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-6" style="background-color:none">
                        <div class="tagline-message">
                        	<img src="public/images/merco3.jpg" alt="" class="img-responsive">
                        	<h1>Mercedes GlE <br> 14 990€</h1>
                        	<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalQuickView">Voir plus</button>
                    ...
                    <div class="col-md-6" style="background-color:none">
                        <div class="tagline-message">
                        	<img src="public/images/merco1.jpg" alt="" class="img-responsive">
                        	<h1>Mercedes Class G <br> 17 540€</h1>
                        	<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalQuickView">Voir plus</button>
                        </div>
                    </div><!-- end col -->
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-6" style="background-color:none">
                        <div class="tagline-message">
                        	<img src="public/images/merco5.jpg" alt="" class="img-responsive">
                        	<h1>Mercedes GlE <br> 14 990€</h1>
                        	<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalQuickView">Voir plus</button>
                    ...
                    <div class="col-md-6" style="background-color:none">
                        <div class="tagline-message">
                        	<img src="public/images/merco4.png" alt="" class="img-responsive">
                        	<h1>Mercedes Class G <br> 17 540€</h1>
                        	<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalQuickView">Voir plus</button>
                        </div>
                    </div><!-- end col -->
